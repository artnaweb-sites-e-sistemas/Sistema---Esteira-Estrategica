        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 border-2 border-purple-200 dark:border-purple-700 rounded-xl p-6">
            ...
            <div className="space-y-3">
              {formData.modules.map((module, index) => (
                <div key={module.id} className="bg-white dark:bg-gray-800 rounded-lg p-4 border-2 border-purple-200 dark:border-purple-700 shadow-sm">
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-2 border-green-200 dark:border-green-700 rounded-xl p-6">
            ...
            <div className="space-y-4">
              {Object.entries(groupedLessons).map(([moduleId, lessons]) => (
                <div key={moduleId} className="bg-white dark:bg-gray-800 rounded-lg p-4 border-2 border-green-200 dark:border-green-700 shadow-sm">
                  <div className="flex flex-col items-start sm:flex-row sm:items-center sm:justify-between mb-3">
                    <h4 className="font-medium text-gray-900 dark:text-white flex items-center space-x-2 mb-2 sm:mb-0">
                      ...
                      <span>{getModuleName(moduleId === 'no-module' ? undefined : moduleId)}</span>
                    </h4>
                    <button
                      type="button"
                      onClick={() => addLesson(moduleId === 'no-module' ? undefined : moduleId)}
                  ...
                  <div className="space-y-2">
                    {lessons.map(({ lesson, index }) => (
                      <div key={lesson.id} className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3 border border-green-100 dark:border-green-800">
                        ...
                        <div className="flex items-center space-x-2 mb-2">
                          <select
                            ...
                            onChange={(e) => updateLesson(index, { moduleId: e.target.value || undefined })}
                            ...
                            {(['todo', 'in-progress', 'completed'] as const).map((status) => {
                              ...
                              return (
                                <button
                                  key={status}
                                  type="button"
                                  onClick={() => updateLesson(index, { status })}
          ...
          <div className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 border-2 border-yellow-200 dark:border-yellow-700 rounded-xl p-6">
            ...
            <div className="space-y-3">
              {formData.bonuses.map((bonus, index) => (
                <div key={bonus.id} className="bg-white dark:bg-gray-800 rounded-lg p-4 border-2 border-amber-200 dark:border-amber-700 shadow-sm">
                  <div className="flex items-center space-x-2 mb-3">
                    <input
                      type="text"
                      value={bonus.name}
